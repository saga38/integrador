...
--
-- Host: localhost    Database: integrador_spring
-- ------------------------------------------------------
...
CREATE TABLE `reservation` (
  ...
  `fechadereservacion` datetime DEFAULT NULL,
...
--
-- Dumping routines for database 'integrador_spring'
--
...
-- Dump completed on 2024-04-12 22:00:05
